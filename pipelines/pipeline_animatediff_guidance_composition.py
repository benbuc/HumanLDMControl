...
class AnimateDiffComposedControlNetPipeline(
    ...
    def prepare_smpl_condition(
        ...
        smpl_condition = smpl_condition.unsqueeze(0).repeat_interleave(
            batch_size, dim=0
        )
    ...
    def __call__(
        ...
        **kwargs,
        ...
        # prepare smpl condition
        smpl_condition = (
            self.prepare_smpl_condition(  # TODO correct shape with frames
                smpl_condition,
                batch_size,
                num_videos_per_prompt,
                device,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if self.do_classifier_free_guidance:
                    ...
                    noise_pred_extra_condition_uncond, noise_pred_smpl_condition = (
                    ...
                    noise_pred = (
                        ...
                        + guidance_scale_smpl_condition
                        * (
                            noise_pred_smpl_condition
                            - noise_pred_extra_condition_uncond
                        )
                    )
